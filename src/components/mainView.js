...
class MainView extends React.Component {
    ...
    async logging() {
        ...
        //     if (moment(m_date).isSameOrAfter(moment().format("YYYY-MM-DD"))) {
        //         console.log(short[i]);
        // const home_Coach = await axios.get(`https://api-football-v1.p.rapidapi.com/v2/coachs/team/${short[i].homeTeam.team_id}`, {
        //             "method": "GET",
        //             "headers": {
        //                 "x-rapidapi-host": "api-football-v1.p.rapidapi.com",
        //                 "x-rapidapi-key": "87b140eb05msh461aa1d79520e3ep12982ejsnbdaf7d3dac51"
        //             }
        //         })
        //         const away_Coach = await axios.get(`https://api-football-v1.p.rapidapi.com/v2/coachs/team/${short[i].awayTeam.team_id}`, {
        //             "method": "GET",
        //             "headers": {
        //                 "x-rapidapi-host": "api-football-v1.p.rapidapi.com",
        //                 "x-rapidapi-key": "87b140eb05msh461aa1d79520e3ep12982ejsnbdaf7d3dac51"
        //             }
        //         })
        //         this.setState({ current_fixture: short[i] });
        //         return;
        //     }
        // }
        // return;
            ...
            <div>
                {this.state.current_fixture ?
                    ...
                    <div style = {{"position": "absolute"}}>
                            ...
                            <Segment style={{ "margin": "10px 400px", "backgroundColor": "transparent" }}>
                                <Grid columns={2} >
                                    <Grid.Column>
